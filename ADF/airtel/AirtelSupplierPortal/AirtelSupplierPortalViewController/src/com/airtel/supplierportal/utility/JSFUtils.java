...
import com.airtel.supplierportal.servlet.UcmFileServlet;
...
public class JSFUtils implements Serializable {
    ...
    private static final ADFLogger _logger = ADFLogger.createADFLogger(JSFUtils.class);

    private static Map<String, SelectItem> selectItems =
        new HashMap<String, SelectItem>();
    private static final long serialVersionUID = 7006942716461660589L;
    ...
    public static ViewObject executeViewObject(String iteratorName) {
        ViewObject vObject = getViewObject(iteratorName);
        vObject.executeQuery();
        _logger.info("....Total rows..." + vObject.getRowCount());
        return vObject;
    }
